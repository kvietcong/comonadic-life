...
/* package comonadic-life-0.0.0.1 */
#ifndef VERSION_comonadic_life
#define VERSION_comonadic_life "0.0.0.1"
#endif /* VERSION_comonadic_life */
#ifndef MIN_VERSION_comonadic_life
#define MIN_VERSION_comonadic_life(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_comonadic_life */
...
#define CURRENT_COMPONENT_ID "comonadic-life-0.0.0.1-inplace-comonads"
